...
public class PaymentP2007_01Record extends TableRecordImpl<PaymentP2007_01Record> implements Record6<Integer, Short, Short, Integer, BigDecimal, Timestamp> {

	private static final long serialVersionUID = 999367256;
	 ...
	 */
	@Override
	public PaymentP2007_01Record values(Integer value1, Short value2, Short value3, Integer value4, BigDecimal value5, Timestamp value6) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public PaymentP2007_01Record(Integer paymentId, Short customerId, Short staffId, Integer rentalId, BigDecimal amount, Timestamp paymentDate) {
		super(PaymentP2007_01.PAYMENT_P2007_01);
