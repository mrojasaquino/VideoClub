...
public class PaymentP2007_04Record extends TableRecordImpl<PaymentP2007_04Record> implements Record6<Integer, Short, Short, Integer, BigDecimal, Timestamp> {

	private static final long serialVersionUID = -487906760;
	 ...
	 */
	@Override
	public PaymentP2007_04Record values(Integer value1, Short value2, Short value3, Integer value4, BigDecimal value5, Timestamp value6) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public PaymentP2007_04Record(Integer paymentId, Short customerId, Short staffId, Integer rentalId, BigDecimal amount, Timestamp paymentDate) {
		super(PaymentP2007_04.PAYMENT_P2007_04);
