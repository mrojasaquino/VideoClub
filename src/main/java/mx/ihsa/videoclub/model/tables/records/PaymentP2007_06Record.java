...
public class PaymentP2007_06Record extends TableRecordImpl<PaymentP2007_06Record> implements Record6<Integer, Short, Short, Integer, BigDecimal, Timestamp> {

	private static final long serialVersionUID = 1383888760;
	 ...
	 */
	@Override
	public PaymentP2007_06Record values(Integer value1, Short value2, Short value3, Integer value4, BigDecimal value5, Timestamp value6) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public PaymentP2007_06Record(Integer paymentId, Short customerId, Short staffId, Integer rentalId, BigDecimal amount, Timestamp paymentDate) {
		super(PaymentP2007_06.PAYMENT_P2007_06);
